...
export const blogs = [
  ...
  },
  {
    ...
    image: "4.jpg",
    dimensions: "relative w-full sm:mt-0 mt-4",
  },
];
...
export const workExperience = [
  {
    ...
    points: [
      {
        text: "Effortless daily order placement",
        thumbnail: "/correct.png",
      },
      {
        text: "Real-time order tracking and updates",
        thumbnail: "/correct.png",
      },
      {
        text: "Automated inventory replenishment",
        thumbnail: "/correct.png",
      },
      {
        text: "Centralized order reception and processing",
        thumbnail: "/correct.png",
      },
      {
        text: "Comprehensive vendor management",
        thumbnail: "/correct.png",
      },
      {
        text: "Insightful analytics and reports",
        thumbnail: "/correct.png",
      },
      {
        text: "Direct communication between hotels and vendors",
        thumbnail: "/correct.png",
      },
      {
  ...
  },
  {
    ...
    points: [
      {
        text: "Manual and time-consuming order placement",
        thumbnail: "/failed.png",
      },
      {
        text: "Lack of real-time order status",
        thumbnail: "/failed.png",
      },
      {
        text: "Risk of running out of essential items",
        thumbnail: "/failed.png",
      },
      {
        text: "Scattered order reception and processing",
        thumbnail: "/failed.png",
      },
      {
        text: "Fragmented vendor communication",
        thumbnail: "/failed.png",
      },
      {
        text: "Limited data for decision making",
        thumbnail: "/failed.png",
      },
      {
      ...
      {
        text: "No integration with existing systems",
        thumbnail: "/failed.png",
      },
    ],
  },
